 ...
 */
export declare function handleAuthentication(req: IncomingMessage, res: ServerResponse, authConfig: AuthConfig | undefined, context: string): Promise<AuthResult | null>;
